...
DATA_PATH=${DATA_PATH:-"/mnt/cluster/LoongForge/deepseek_v4/sft_data"}

TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/huggingface.co/deepseek-ai/DeepSeek-V4"}

CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/LoongForge/deepseek_v4/DeepSeek-V4-bf16-tp8pp8ep32etp1"}
CHECKPOINT_PATH_SAVE=${CHECKPOINT_PATH_SAVE:-"/mnt/cluster/LoongForge/deepseek_v4/save/DeepSeek-V4-tp8pp8ep32etp1"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/LoongForge/tensorboard-log/deepseek-v4-sft"}
...
TRAINING_ARGS=(
  ...
  --enable-experimental
  --use-fp32-dtype-for-param-pattern self_attention_hyper_connection mlp_hyper_connection
  --freeze-parameters-regex '^(?:decoder\..*|(?:.*\.)?(?:embedding|output_layer).*)$'
)
...
MODEL_PARALLEL_ARGS=(
  ...
  #--sequence-parallel  # DISABLED: V4 attention does not support SP
