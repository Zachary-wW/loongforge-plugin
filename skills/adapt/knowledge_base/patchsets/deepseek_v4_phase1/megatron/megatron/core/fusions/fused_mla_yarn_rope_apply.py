...
# Backward-compatible class aliases used by LoongForge fused DSA wrappers.
ApplyMLARotaryEmbQ = _FusedMLARoPEInplace
ApplyMLARotaryEmbKV = _FusedMLARoPEKVSplit
