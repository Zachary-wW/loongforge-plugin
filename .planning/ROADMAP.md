...
- [x] 10-02-PLAN.md — Code + doc updates: validators, range(7), SKILL.md, EXIT_CONTRACT.md, schema_version (Wave 2)
- [x] 10-03-PLAN.md — Test updates for 7-phase structure (Wave 3)
